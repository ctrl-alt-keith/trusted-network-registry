...
| The Meraki Dashboard API exposes organization uplink statuses and uplink address surfaces. | MVP Meraki code is limited to sanitized fixture parsing shaped like documented uplink data. | [Cisco Meraki Dashboard API: uplink statuses](https://developer.cisco.com/meraki/api-v1/get-organization-uplinks-statuses/), [Cisco Meraki Dashboard API getting started](https://developer.cisco.com/meraki/api-v1/getting-started/) | 2026-05-17 |
